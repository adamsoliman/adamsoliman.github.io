...
<button onclick="toggleText('abstract2')">Show Abstract</button>
...
<button onclick="toggleText('abstract3')">Show Abstract</button>
...
<button onclick="toggleText('abstract4')">Show Abstract</button>
...
<button onclick="toggleText('abstract5')">Show Abstract</button>
